...
export interface ICustomFormProps<T> {
    data?: T | Partial<T>;
    ...
    validateData?(values: T): IFieldError[];

    validate?(errors: object, values: T): object;
}

@autobind
export class CustomForm<T> extends Component<ICustomFormProps<T>> {
